...
public class StudentSwingView extends JFrame implements StudentView {
	...
	/**
	 * Configuriamo JList con un list model. Creiamo un modello della lista di default per
	 * memorizzare gli oggetti Student. Utilizzeremo il modello della lista per memorizzare
	 * e rimuovere gli oggetti Student.
	 */
	...
	/**
	 * Dobbiamo accedere al modello della lista dal nostro test quindi
	 * utilizziamo un metodo getter package-private.
	 */
	...
	public StudentSwingView() {
		...
		// Se idTextBox e nameTextBox non sono vuoti allora il bottone Add è abilitato.
		...
		listStudents.setCellRenderer(new DefaultListCellRenderer() {
			...
			public Component getListCellRendererComponent(JList<?> list, Object value,
				...
				return super.getListCellRendererComponent(
						list, getDisplayString(student), index, isSelected, cellHasFocus);
			}
		});
